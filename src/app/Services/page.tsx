...
export default function Services() {
  ...
  return (
    <><Header /><div className="min-h-screen bg-gradient-to-br from-gray-900 via-gray-800 to-gray-900">
      {/* Hero Section */}
            ...
            {serviceInfo.map((service, index) => {
              ...
              return (
                ...
                >
                  ...
                  >
                    <Heart
                      className={`w-4 h-4 transition-colors ${isFavorite ? "fill-red-500 text-red-500" : "text-white hover:text-red-400"}`} />
                  </button>
...
//                     const IconComponent = getIconsComponents(service.icons);
...
// import { createClient } from "next-sanity";
// import { useEffect, useState } from "react";
// import SanityService from "../../../script/dataType";
